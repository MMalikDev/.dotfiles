...
-- https://github.com/DaiterGG/neovim-config/blob/main/lua/custom/plugins/alpha.lua
...
return {
 ...
 ██████   ██  ███████████████   ██ █████████████████
    ...
    dashboard.section.buttons.val = {
      dashboard.button('f', ' Find File', ":lua Snacks.dashboard.pick('files', { hidden = true })<CR>"),
      dashboard.button('g', ' Find Text', ":lua Snacks.dashboard.pick('live_grep', { hidden = true })<CR>"),
      dashboard.button('p', ' Projects', ':lua Snacks.picker.projects()<CR>'),
      dashboard.button('n', ' New File', ':e untitled<CR>'),
