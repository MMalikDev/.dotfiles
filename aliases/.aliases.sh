...
alias uel='find . -type f -exec dos2unix {} \;'
...
alias pgsql="de postgres psql -h localhost -p 5432 -d postgres -U admin"  # Use DB CLI for postgres in docker
...
## multiple .configs: ~/.config/nvim-*

alias lazy='NVIM_APPNAME="nvim-lazyvim" nvim'
alias nv-get-lazy='git clone --depth 1 https://github.com/LazyVim/starter             ~/.config/nvim-lazyvim'
alias nv-del-lazy='rm -rf ~/.config/nvim-lazyvim ~/.local/share/nvim-lazyvim ~/.cache/nvim-lazyvim ~/.local/state/nvim-lazyvim'
